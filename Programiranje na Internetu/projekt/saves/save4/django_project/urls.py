...
urlpatterns = [
    ...
    path('mentor_studenti/', user_views.MentorStudentiView.as_view(), name='mentor_studenti'),
    path('mentor_studenti_redovni/', user_views.MentorStudentiRedovniView.as_view(), name='mentor_studenti_redovni'),
    path('mentor_studenti_izvanredni/', user_views.MentorStudentiIzvanredniView.as_view(), name='mentor_studenti_izvanredni'),
    path('mentor_predmeti/', user_views.mentor_predmeti_view, name='mentor_predmeti'),
    path('student/<int:pk>/', user_views.student_view_pk, name='student'),
